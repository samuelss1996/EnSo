        ...
        int numero=0;
            ...
            try {
              ...
              try {
                    ...
                    System.out.println("Excepcion en lectura de liña en ImportsModule.java Importar usuarios na lectura do archivo:" + ioe);
                }
      ...
      FileInputStream archivo;
          ...
          int numero=0;
              ...
              try {
                  ...
                  System.out.println("Excepcion en lectura de liña en ImportsModule.java Importar productos na lectura do archivo:" + ioe);
              }
        ...
        try {
            ...
            try {
               ...
               if(partes[0].equals("V") && partes[1].length()==11 && partes[2].length()==10 && partes[3].length()==11 && partes[4].length()==11 && !partes[5].isEmpty() && !partes[6].isEmpty()){
                ...
                System.out.println("Excepcion en lectura de liña en ImportsModule.java Importar compra na lectura do archivo:" + ioe);
            }
